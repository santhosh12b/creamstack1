      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-[1000px] mx-auto mt-12 sm:mt-16 bg-[#F8FAFC] rounded-[2.5rem] p-8 sm:p-12 border border-slate-100/80 shadow-[0_4px_30px_-5px_rgba(0,0,0,0.03)]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-6">
            {/* Card 1 */}
            <div className="bg-white rounded-[1.25rem] p-5 sm:p-6 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.06)] border border-slate-100/60 flex items-center gap-4 sm:gap-5 hover:-translate-y-1 transition-transform duration-300 h-full">
              <div className="w-[52px] h-[52px] rounded-full bg-[#EFF6FF] text-[#3B82F6] flex items-center justify-center shrink-0">
              ...
              <div className="flex flex-col flex-1 items-start">
                <p className="text-[13px] font-bold text-[#1E293B] leading-snug mb-3">
                  ...
                  <span className="block mt-0.5">+ Personalised Message Suggestion</span>
                </p>
                <span className="inline-flex px-3 py-1 bg-[#EFF6FF] text-[#3B82F6] text-[11px] font-bold rounded-lg">
                  2 credits
                </span>
              </div>
            </div>
            ...
            {/* Card 2 */}
            <div className="bg-white rounded-[1.25rem] p-5 sm:p-6 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.06)] border border-slate-100/60 flex items-center gap-4 sm:gap-5 hover:-translate-y-1 transition-transform duration-300 h-full">
              <div className="w-[52px] h-[52px] rounded-full bg-[#ECFDF5] text-[#10B981] flex items-center justify-center shrink-0">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                  <polyline points="22,6 12,13 2,6"></polyline>
                </svg>
              ...
              <div className="flex flex-col flex-1 items-center text-center">
                ...
                <span className="inline-flex px-3 py-1 bg-[#ECFDF5] text-[#10B981] text-[11px] font-bold rounded-lg">
                  1 credit
                </span>
              </div>
            </div>
            ...
            {/* Card 3 */}
            <div className="bg-white rounded-[1.25rem] p-5 sm:p-6 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.06)] border border-slate-100/60 flex items-center gap-4 sm:gap-5 hover:-translate-y-1 transition-transform duration-300 h-full">
              <div className="w-[52px] h-[52px] rounded-full bg-[#FFFBEB] text-[#F59E0B] flex items-center justify-center shrink-0">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="flex flex-col flex-1 items-center text-center">
                ...
                <span className="inline-flex px-3 py-1 bg-[#FFFBEB] text-[#F59E0B] text-[11px] font-bold rounded-lg">
                  4 credits
                </span>
              </div>
            </div>
