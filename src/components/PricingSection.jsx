      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="block md:hidden w-full max-w-md mx-auto">
          ...
          <div className="bg-white rounded-3xl border border-slate-200/90 shadow-xl overflow-hidden p-5 sm:p-6 transition-all duration-300 relative">
            ...
            <a
              ...
              className={`w-full py-3.5 px-5 rounded-2xl font-extrabold text-sm transition-all duration-200 min-h-[48px] flex items-center justify-center gap-2 cursor-pointer shadow-md active:scale-[0.98] ${currentMobilePlan.btnStyle}`}
            >
                ...
                <div className="px-6 pb-6 pt-10 text-center flex flex-col hover:bg-slate-50/50 transition-colors h-full">
                  ...
                  <div className="mt-auto pt-6">
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full py-2.5 px-4 rounded-xl border-2 border-purple-200 text-purple-700 font-extrabold hover:bg-purple-600 hover:text-white hover:border-purple-600 transition-all duration-200 text-sm min-h-[44px] cursor-pointer flex items-center justify-center text-center inline-block"
                    >
                      Start Trial
                    </a>
                  </div>
                ...
                <div className="px-6 pb-6 pt-10 text-center border-r border-slate-200 flex flex-col hover:bg-slate-50/50 transition-colors h-full">
                  ...
                  <div className="mt-auto pt-6">
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full py-2.5 px-4 rounded-xl border-2 border-primary/40 text-primary font-extrabold hover:bg-primary hover:text-white hover:border-primary transition-all duration-200 text-sm min-h-[44px] cursor-pointer flex items-center justify-center text-center inline-block"
                    >
                      Choose Starter
                    </a>
                  </div>
                ...
                <div className="px-6 pb-6 pt-10 text-center relative bg-gradient-to-b from-primary/[0.04] to-transparent flex flex-col border-r border-slate-200 shadow-inner h-full">
                  ...
                  <div className="mt-auto pt-6">
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full py-2.5 px-4 rounded-xl bg-primary text-white font-extrabold shadow-lg shadow-primary/25 hover:bg-primary-hover hover:-translate-y-0.5 transition-all duration-200 text-sm min-h-[44px] cursor-pointer flex items-center justify-center text-center inline-block"
                    >
                      Choose Growth
                    </a>
                  </div>
                ...
                <div className="px-6 pb-6 pt-10 text-center flex flex-col hover:bg-slate-50/50 transition-colors h-full">
                  ...
                  <div className="mt-auto pt-6">
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full py-2.5 px-4 rounded-xl border-2 border-emerald-500/40 text-emerald-600 font-extrabold hover:bg-emerald-600 hover:text-white hover:border-emerald-600 transition-all duration-200 text-sm min-h-[44px] cursor-pointer flex items-center justify-center text-center inline-block"
                    >
                      Choose Scale
                    </a>
                  </div>
        ...
        <div className="max-w-[1000px] mx-auto mt-12 sm:mt-16 bg-[#F8FAFC] rounded-[2.5rem] p-8 sm:p-12 border border-slate-100/80 shadow-[0_4px_30px_-5px_rgba(0,0,0,0.03)]">
          <div className="mb-10 flex flex-col items-start">
            ...
            <h3 className="text-3xl sm:text-[32px] font-extrabold text-[#0F172A] tracking-tight mb-2">
              Credits power your outreach.
            </h3>
            <p className="text-[14px] text-[#64748B] font-medium">
              Credits are used for enrichment, AI suggestions and finding contact details.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {/* Card 1 */}
            <div className="bg-white rounded-[1.25rem] p-5 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.06)] border border-slate-100/60 flex flex-col items-center text-center gap-4 hover:-translate-y-1 transition-transform duration-300 h-full">
              <div className="w-[48px] h-[48px] rounded-full bg-[#EFF6FF] text-[#3B82F6] flex items-center justify-center shrink-0">
              ...
              <div className="flex flex-col flex-1 items-center justify-between w-full">
                <p className="text-[13px] font-bold text-[#1E293B] leading-snug mb-3">
                  Profile & Company Enrichment
                </p>
                <span className="inline-flex px-3 py-1 bg-[#EFF6FF] text-[#3B82F6] text-[11px] font-bold rounded-lg mt-auto">
                  1 credit
                </span>
              </div>
            </div>
            ...
            {/* Card 2 */}
            <div className="bg-white rounded-[1.25rem] p-5 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.06)] border border-slate-100/60 flex flex-col items-center text-center gap-4 hover:-translate-y-1 transition-transform duration-300 h-full">
              <div className="w-[48px] h-[48px] rounded-full bg-[#F5F3FF] text-[#8B5CF6] flex items-center justify-center shrink-0">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="flex flex-col flex-1 items-center justify-between w-full">
                <p className="text-[13px] font-bold text-[#1E293B] leading-snug mb-3">
                  Personalised Message Suggestion
                </p>
                <span className="inline-flex px-3 py-1 bg-[#F5F3FF] text-[#8B5CF6] text-[11px] font-bold rounded-lg mt-auto">
                  1 credit
                </span>
              </div>
            </div>
            ...
            {/* Card 3 */}
            <div className="bg-white rounded-[1.25rem] p-5 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.06)] border border-slate-100/60 flex flex-col items-center text-center gap-4 hover:-translate-y-1 transition-transform duration-300 h-full">
              <div className="w-[48px] h-[48px] rounded-full bg-[#ECFDF5] text-[#10B981] flex items-center justify-center shrink-0">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                  <polyline points="22,6 12,13 2,6"></polyline>
                </svg>
              ...
              <div className="flex flex-col flex-1 items-center justify-between w-full">
                ...
                <span className="inline-flex px-3 py-1 bg-[#ECFDF5] text-[#10B981] text-[11px] font-bold rounded-lg mt-auto">
                  1 credit
                </span>
              </div>
            </div>
            ...
            {/* Card 4 */}
            <div className="bg-white rounded-[1.25rem] p-5 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.06)] border border-slate-100/60 flex flex-col items-center text-center gap-4 hover:-translate-y-1 transition-transform duration-300 h-full">
              <div className="w-[48px] h-[48px] rounded-full bg-[#FFFBEB] text-[#F59E0B] flex items-center justify-center shrink-0">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="flex flex-col flex-1 items-center justify-between w-full">
                ...
                <span className="inline-flex px-3 py-1 bg-[#FFFBEB] text-[#F59E0B] text-[11px] font-bold rounded-lg mt-auto">
                  4 credits
                </span>
              </div>
            </div>
        ...
        {/* ========================================================================= */}
        <div className="max-w-[1000px] mx-auto mt-8 sm:mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10">
