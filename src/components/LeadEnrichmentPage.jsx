        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="relative mt-10 sm:mt-16 max-w-5xl mx-auto text-left">
            ...
            <div className="rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl bg-white border border-slate-200/90 overflow-hidden relative transition-transform duration-500 hover:scale-[1.01]">
              {/* Mockup Topbar */}
              <div className="px-4 sm:px-6 py-3.5 sm:py-4 border-b border-slate-100 bg-slate-50/70 flex items-center justify-between">
                <div className="flex items-center gap-2 sm:gap-3">
                  <img src="/33.png" alt="CreamStack" className="w-5 h-5 object-contain" />
                  <span className="font-bold text-xs sm:text-sm text-secondary">Creamstack</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="relative hidden sm:block">
                    <input 
                      ...
                      readOnly 
                      value="" 
                      className="bg-white border border-slate-200 rounded-lg px-3 py-1.5 text-xs text-slate-500 w-36 sm:w-48 outline-none" 
                    />
                  </div>
                  <button className="px-2.5 sm:px-3 py-1.5 rounded-lg border border-slate-200 bg-white text-[11px] sm:text-xs font-semibold text-slate-600 flex items-center gap-1">
                    <FilterIcon /> Filter
                  </button>
                  <button className="px-2.5 sm:px-3 py-1.5 rounded-lg bg-primary text-white text-[11px] sm:text-xs font-semibold shadow-sm flex items-center gap-1">
                    + Add Leads
                  </button>
                </div>
              </div>
              ...
              <div className="hidden sm:block p-6 overflow-x-auto">
                <table className="w-full text-left text-xs">
                  ...
                  <tbody className="divide-y divide-slate-100 font-medium text-slate-700">
                    <tr className="hover:bg-slate-50/80 transition-colors">
                      <td className="py-3 flex items-center gap-2 font-bold text-secondary">
                        <img src="https://i.pravatar.cc/100?img=32" alt="Sarah" className="w-7 h-7 rounded-full object-cover" />
                        Sarah Johnson
                      </td>
                      <td className="py-3 text-slate-600">Marketing Manager</td>
                      <td className="py-3 flex items-center gap-1.5 font-bold text-secondary">
                        <span className="w-4 h-4 rounded bg-slate-900 text-white text-[9px] flex items-center justify-center font-black">N</span>
                        Notion
                      </td>
                      <td className="py-3 font-mono text-[11px] text-slate-600">sarah@notion.so</td>
                      <td className="py-3 text-right">
                        <span className="bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full font-bold text-[10px]">98</span>
                      </td>
                    </tr>
                    <tr className="hover:bg-slate-50/80 transition-colors">
                      <td className="py-3 flex items-center gap-2 font-bold text-secondary">
                        <img src="https://i.pravatar.cc/100?img=12" alt="Alex" className="w-7 h-7 rounded-full object-cover" />
                        Alex Morgan
                      </td>
                      <td className="py-3 text-slate-600">Head of Growth</td>
                      <td className="py-3 flex items-center gap-1.5 font-bold text-secondary">
                        <span className="w-4 h-4 rounded bg-amber-400 text-slate-900 text-[9px] flex items-center justify-center font-black">R</span>
                        Ramp
                      </td>
                      <td className="py-3 font-mono text-[11px] text-slate-600">alex@ramp.com</td>
                      <td className="py-3 text-right">
                        <span className="bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full font-bold text-[10px]">96</span>
                      </td>
                    </tr>
                    <tr className="hover:bg-slate-50/80 transition-colors">
                      <td className="py-3 flex items-center gap-2 font-bold text-secondary">
                        <img src="https://i.pravatar.cc/100?img=60" alt="David" className="w-7 h-7 rounded-full object-cover" />
                        David Lee
                      </td>
                      <td className="py-3 text-slate-600">Founder</td>
                      <td className="py-3 flex items-center gap-1.5 font-bold text-secondary">
                        <span className="w-4 h-4 rounded bg-purple-600 text-white text-[9px] flex items-center justify-center font-black">L</span>
                        Loom
                      </td>
                      <td className="py-3 font-mono text-[11px] text-slate-600">david@loom.com</td>
                      <td className="py-3 text-right">
                        <span className="bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full font-bold text-[10px]">94</span>
                      </td>
                    </tr>
                    <tr className="hover:bg-slate-50/80 transition-colors">
                      <td className="py-3 flex items-center gap-2 font-bold text-secondary">
                        <img src="https://i.pravatar.cc/100?img=47" alt="Emma" className="w-7 h-7 rounded-full object-cover" />
                        Emma Williams
                      </td>
                      <td className="py-3 text-slate-600">Growth Lead</td>
                      <td className="py-3 flex items-center gap-1.5 font-bold text-secondary">
                        <span className="w-4 h-4 rounded bg-blue-600 text-white text-[9px] flex items-center justify-center font-black">W</span>
                        Webflow
                      </td>
                      <td className="py-3 font-mono text-[11px] text-slate-600">emma@webflow.com</td>
                      <td className="py-3 text-right">
                        <span className="bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full font-bold text-[10px]">93</span>
                      </td>
                    </tr>
                    <tr className="hover:bg-slate-50/80 transition-colors">
                      <td className="py-3 flex items-center gap-2 font-bold text-secondary">
                        <img src="https://i.pravatar.cc/100?img=53" alt="James" className="w-7 h-7 rounded-full object-cover" />
                        James Carter
                      </td>
                      <td className="py-3 text-slate-600">CMO</td>
                      <td className="py-3 flex items-center gap-1.5 font-bold text-secondary">
                        <span className="w-4 h-4 rounded bg-orange-500 text-white text-[9px] flex items-center justify-center font-black">H</span>
                        HubSpot
                      </td>
                      <td className="py-3 font-mono text-[11px] text-slate-600">james@hubspot.com</td>
                      <td className="py-3 text-right">
                        <span className="bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full font-bold text-[10px]">92</span>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              {/* Mobile-Native Leads List Layout (visible on mobile only) */}
              <div className="block sm:hidden divide-y divide-slate-100 p-2.5">
                {/* Lead Item 1: Sarah Johnson */}
                <div className="p-2.5 flex flex-col gap-1.5 hover:bg-slate-50 rounded-xl transition-colors">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <img src="https://i.pravatar.cc/100?img=32" alt="Sarah" className="w-8 h-8 rounded-full object-cover shadow-xs" />
                      <div>
                        <div className="font-bold text-xs text-secondary">Sarah Johnson</div>
                        <div className="text-[10px] text-slate-500 font-medium">Marketing Manager</div>
                      </div>
                    </div>
                    <span className="bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full font-extrabold text-[10px]">
                      98 score
                    </span>
                  </div>
                  <div className="flex items-center justify-between text-[11px] pt-1 pl-10">
                    <div className="flex items-center gap-1 font-semibold text-secondary">
                      <span className="w-3.5 h-3.5 rounded bg-slate-900 text-white text-[8px] flex items-center justify-center font-black">N</span>
                      Notion
                    </div>
                ...
                {/* Lead Item 2: Alex Morgan */}
                <div className="p-2.5 flex flex-col gap-1.5 hover:bg-slate-50 rounded-xl transition-colors">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <img src="https://i.pravatar.cc/100?img=12" alt="Alex" className="w-8 h-8 rounded-full object-cover shadow-xs" />
                      <div>
                        <div className="font-bold text-xs text-secondary">Alex Morgan</div>
                        <div className="text-[10px] text-slate-500 font-medium">Head of Growth</div>
                      </div>
                    </div>
                    <span className="bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full font-extrabold text-[10px]">
                      96 score
                  ...
                  <div className="flex items-center justify-between text-[11px] pt-1 pl-10">
                    <div className="flex items-center gap-1 font-semibold text-secondary">
                      <span className="w-3.5 h-3.5 rounded bg-amber-400 text-slate-900 text-[8px] flex items-center justify-center font-black">R</span>
                      Ramp
                    </div>
                    <div className="font-mono text-[10px] text-slate-500 bg-slate-100 px-2 py-0.5 rounded">
                      alex@ramp.com
                ...
                {/* Lead Item 3: David Lee */}
                <div className="p-2.5 flex flex-col gap-1.5 hover:bg-slate-50 rounded-xl transition-colors">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <img src="https://i.pravatar.cc/100?img=60" alt="David" className="w-8 h-8 rounded-full object-cover shadow-xs" />
                      <div>
                        <div className="font-bold text-xs text-secondary">David Lee</div>
                        <div className="text-[10px] text-slate-500 font-medium">Founder</div>
                      </div>
                    </div>
                    <span className="bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full font-extrabold text-[10px]">
                      94 score
                  ...
                  <div className="flex items-center justify-between text-[11px] pt-1 pl-10">
                    <div className="flex items-center gap-1 font-semibold text-secondary">
                      <span className="w-3.5 h-3.5 rounded bg-purple-600 text-white text-[8px] flex items-center justify-center font-black">L</span>
                      Loom
                    </div>
                    <div className="font-mono text-[10px] text-slate-500 bg-slate-100 px-2 py-0.5 rounded">
                      david@loom.com
                ...
                {/* Lead Item 4: Emma Williams */}
                <div className="p-2.5 flex flex-col gap-1.5 hover:bg-slate-50 rounded-xl transition-colors">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <img src="https://i.pravatar.cc/100?img=47" alt="Emma" className="w-8 h-8 rounded-full object-cover shadow-xs" />
                      <div>
                        <div className="font-bold text-xs text-secondary">Emma Williams</div>
                        <div className="text-[10px] text-slate-500 font-medium">Growth Lead</div>
                      </div>
                    </div>
                    <span className="bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full font-extrabold text-[10px]">
                      93 score
                  ...
                  <div className="flex items-center justify-between text-[11px] pt-1 pl-10">
                    <div className="flex items-center gap-1 font-semibold text-secondary">
                      <span className="w-3.5 h-3.5 rounded bg-blue-600 text-white text-[8px] flex items-center justify-center font-black">W</span>
                      Webflow
                    </div>
                    <div className="font-mono text-[10px] text-slate-500 bg-slate-100 px-2 py-0.5 rounded">
                      emma@webflow.com
              ...
              <div className="bg-slate-50/90 border-t border-slate-100 p-3 sm:p-4 grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 text-center">
                <div className="flex items-center justify-center gap-2 p-1.5 sm:p-0">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-blue-100 text-blue-700 flex items-center justify-center font-bold text-xs shrink-0">
                    👥
                  </div>
                  <div className="text-left">
                    <div className="font-extrabold text-xs sm:text-sm text-secondary">10K+</div>
                    <div className="text-[9px] sm:text-[10px] text-text-light">Leads Enriched</div>
                  </div>
                </div>
                <div className="flex items-center justify-center gap-2 p-1.5 sm:p-0">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-emerald-100 text-emerald-700 flex items-center justify-center font-bold text-xs shrink-0">
                    ✉️
                  </div>
                  <div className="text-left">
                    <div className="font-extrabold text-xs sm:text-sm text-secondary">98%</div>
                    <div className="text-[9px] sm:text-[10px] text-text-light">Email Accuracy</div>
                  </div>
                </div>
                <div className="flex items-center justify-center gap-2 p-1.5 sm:p-0">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-purple-100 text-primary flex items-center justify-center font-bold text-xs shrink-0">
                    📊
                  </div>
                  <div className="text-left">
                    <div className="font-extrabold text-xs sm:text-sm text-secondary">30+</div>
                    <div className="text-[9px] sm:text-[10px] text-text-light">Data Points</div>
                  </div>
                </div>
                <div className="flex items-center justify-center gap-2 p-1.5 sm:p-0">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-amber-100 text-amber-700 flex items-center justify-center font-bold text-xs shrink-0">
                    🚀
                  </div>
                  <div className="text-left">
                    <div className="font-extrabold text-xs sm:text-sm text-secondary">5x</div>
                    <div className="text-[9px] sm:text-[10px] text-text-light">Your Reply Rate</div>
                  </div>
                </div>
              </div>
            </div>
