...
const CTASection = ({ onNavigate }) => {
  return (
    <section id="demo" className="py-24 bg-gradient-to-b from-white via-slate-50 to-white relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6">
        {/* Main CTA Canvas */}
        <div className="relative rounded-[32px] sm:rounded-[40px] bg-gradient-to-br from-[#0c0f1d] via-[#11162b] to-[#0a0d18] border border-white/10 shadow-[0_30px_100px_-20px_rgba(94,43,255,0.35)] overflow-hidden p-8 sm:p-12 lg:p-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10">
            ...
            <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left">
              {/* Floating Badge */}
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 px-4 py-1.5 rounded-full text-xs font-extrabold tracking-wider text-purple-200 uppercase mb-6 shadow-xs">
              ...
              <p className="text-base sm:text-lg text-slate-300 max-w-xl mb-8 leading-relaxed font-medium whitespace-normal lg:whitespace-nowrap">
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 mb-8">
                <button 
                  ...
                  className="px-8 py-4 rounded-2xl bg-gradient-to-r from-primary via-[#7c3aed] to-[#9333ea] text-white font-extrabold text-base shadow-xl shadow-primary/40 hover:shadow-primary/60 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 flex items-center gap-2.5 cursor-pointer group"
                >
                ...
                <a 
                  ...
                  className="px-7 py-4 rounded-2xl border border-white/20 bg-white/10 hover:bg-white/20 text-white font-bold text-base shadow-sm backdrop-blur-md transition-all duration-200 flex items-center gap-2.5 hover:border-white/40 cursor-pointer group"
                >
