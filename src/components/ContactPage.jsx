...
const ContactPage = ({ onNavigate }) => {
  ...
  return (
    <div className="bg-white min-h-screen pt-10 sm:pt-16 pb-0">
      <div className="container mx-auto px-4 sm:px-6 max-w-6xl mb-16 sm:mb-24">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
          ...
          <p className="text-sm sm:text-base text-slate-500 font-normal">
            Get in touch with our team for support or partnership opportunities
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col justify-start">
            ...
            <p className="text-sm text-slate-500 leading-relaxed font-normal mb-8 sm:mb-10">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 m-0 mb-1">For general inquiries and support</p>
                  <a 
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-rose-50 text-rose-400 flex items-center justify-center shrink-0 mt-0.5">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                  </svg>
                </div>
                <div>
                  <h4 className="text-sm font-bold text-slate-900 mb-0.5">Schedule a Call</h4>
                  <p className="text-xs text-slate-500 m-0 mb-1">Book a demo or consultation</p>
                  <a 
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-sm font-bold text-slate-900 mb-0.5">Our Location</h4>
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-sky-50 text-sky-500 flex items-center justify-center shrink-0 mt-0.5">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div>
                  <h4 className="text-sm font-bold text-slate-900 mb-0.5">Response Time</h4>
                  <p className="text-xs text-slate-500 m-0 leading-relaxed max-w-xs">
          ...
          <div className="lg:col-span-7">
            <div className="bg-white rounded-3xl border border-slate-200/80 p-6 sm:p-8 shadow-xl shadow-slate-900/5">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200/90 text-xs sm:text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 transition-all placeholder:text-slate-400"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-semibold text-slate-700 mb-1.5">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200/90 text-xs sm:text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 transition-all appearance-none bg-white text-slate-700 pr-10 cursor-pointer"
                      >
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200/90 text-xs sm:text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 transition-all placeholder:text-slate-400 resize-y"
                    ></textarea>
                  </div>
                  ...
                  <button 
                    type="submit" 
                    className="mt-2 w-full py-3 px-6 rounded-xl bg-blue-500 hover:bg-blue-600 text-white font-bold text-sm shadow-md shadow-blue-500/20 active:scale-[0.99] transition-all cursor-pointer flex items-center justify-center gap-2"
                  >
