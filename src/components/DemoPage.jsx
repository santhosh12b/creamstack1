  ...
  return (
    <div className="min-h-screen bg-slate-50/50 pt-8 sm:pt-12 pb-24 relative overflow-hidden flex flex-col">
      ...
      <div className="container px-4 sm:px-6 relative z-10 max-w-5xl mx-auto flex-1 flex flex-col items-center">
        ...
        <div className="w-full max-w-[960px] mx-auto aspect-video relative bg-slate-900 rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl shadow-slate-900/20 border border-slate-200 group">
          ...
          {isPlaying && (
            <iframe 
              ...
              src="https://www.youtube.com/embed/5CvDMI2n07Y?si=LBhLDsUMkQGCzqvk&autoplay=1&rel=0&modestbranding=1" 
